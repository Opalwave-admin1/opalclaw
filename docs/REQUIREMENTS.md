...
OpalClaw gives you the core functionality without that mess.
...
> **Note:** Telegram, Slack, Discord, Gmail, and Apple Container skills already exist. See the [skills documentation](https://docs.opalclaw.dev/integrations/skills-system) for the full list.
...
- Custom `opalclaw` MCP server (inside container) provides scheduling tools
...
- `/update-opalclaw` - Pull upstream changes, merge with customizations
...
**OpalClaw** - A reference to Clawdbot (now OpenClaw).
