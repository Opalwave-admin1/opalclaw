...
```yaml
- uses: qwibitai/opalclaw/repo-tokens@v1
  with:
    include: 'src/**/*.ts'
    exclude: 'src/**/*.test.ts'
```
...
| Repo | Badge |
|------|-------|
| [OpalClaw](https://github.com/qwibitai/OpalClaw) | ![tokens](https://raw.githubusercontent.com/qwibitai/OpalClaw/main/repo-tokens/badge.svg) |
