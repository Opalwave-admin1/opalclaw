---
name: capabilities
description: Show what this OpalClaw instance can do — installed skills, available tools, and system info. Read-only. Use when the user asks what the bot can do, what's installed, or runs /capabilities.
---

# /capabilities — System Capabilities Report

Generate a structured read-only report of what this OpalClaw instance can do.
...
- **MCP:** mcp__opalclaw__* (messaging, tasks, group management)

### 3. MCP server tools

The OpalClaw MCP server exposes these tools (via `mcp__opalclaw__*` prefix):
