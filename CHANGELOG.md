...
All notable changes to OpalClaw will be documented in this file.

For detailed release notes, see the [full changelog on the documentation site](https://docs.opalclaw.dev/changelog).
...
- Added `/update-opalclaw` skill for syncing with upstream
