...
This skill adds Telegram support to OpalClaw, then walks through interactive setup.
...
```bash
git remote add telegram https://github.com/qwibitai/opalclaw-telegram.git
```
...
- Check bot is started: `tail -f logs/opalclaw.log`
