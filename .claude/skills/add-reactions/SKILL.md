...
This skill adds emoji reaction support to OpalClaw's WhatsApp channel: receive and store reactions, send reactions from the container agent via MCP tool, and query reaction history from SQLite.
...
- Check OpalClaw logs for `Failed to process reaction` errors
