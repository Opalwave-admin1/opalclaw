---
name: add-discord
description: Add Discord bot channel integration to OpalClaw.
---

# Add Discord Channel

This skill adds Discord support to OpalClaw, then walks through interactive setup.
...
```bash
git remote add discord https://github.com/qwibitai/opalclaw-discord.git
```
...
4. Service is running: `launchctl list | grep opalclaw`
...
- @mention translation (Discord `<@botId>` → OpalClaw trigger format)
