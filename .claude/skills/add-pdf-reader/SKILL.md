---
name: add-pdf-reader
description: Add PDF reading to OpalClaw agents. Extracts text from PDFs via pdftotext CLI. Handles WhatsApp attachments, URLs, and local files.
---
...
```bash
tail -f logs/opalclaw.log | grep -i pdf
```
