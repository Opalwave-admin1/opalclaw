...
This skill adds Slack support to OpalClaw, then walks through interactive setup.
...
```bash
git remote add slack https://github.com/qwibitai/opalclaw-slack.git
```
...
>
> The JID format for OpalClaw is: `slack:C0123456789`
...
6. Restart: `launchctl kickstart -k gui/$(id -u)/com.opalclaw`
